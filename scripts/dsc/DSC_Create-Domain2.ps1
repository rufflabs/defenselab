Configuration ADDomain_NewForest_Config
{
    ...
    node 'localhost'
    {
        ...
        TestScript
        {
            TestScript TestDomainCreation
            {
                TestScriptName = "Test domain creation"
                TestScriptDescription = "Tests that the example.com domain was created"
                ExpectedResult = "Domain was created successfully"
                DomainName = "defense.local"
            }
        }
    }
